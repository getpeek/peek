...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            storage_commands::append_history,
            storage_commands::load_history,
            storage_commands::save_history,
            config::get_config,
            config::set_theme,
            ...
            config::set_ui_titlebar_collaboration_button,
            config::set_ui_titlebar_live_query_count,
